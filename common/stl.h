...
inline void stl_lowers(std::string& rstRet) noexcept
{
...
namespace std
{
	...
	template<class _Ty> inline void_mem_fun_t<_Ty> void_mem_fun(void (_Ty::* _Pm)())
	{
	...
	template<class _Ty> inline void_mem_fun_ref_t<_Ty> void_mem_fun_ref(void (_Ty::* _Pm)())
	{
