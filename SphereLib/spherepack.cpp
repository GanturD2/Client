...
SpherePack * SpherePackFactory::AddSphere_(const Vector3d & pos, float radius, void * userdata, bool isSphere, int flags)
{
...
#endif
		SpherePack * pack = mChildren;
		while (pack) // we nullptr (m2l OK) if cculling not process|update()ed
		{
