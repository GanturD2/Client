...
PyObject * grpTextSetFontName(PyObject * poSelf, PyObject * poArgs)
{
	...
	pTextInstance->SetTextPointer(msl::inherit_cast<CGraphicText *>(pResource));
	return Py_BuildNone();
}
...
PyObject * grpGetSplitingTextLine(PyObject * poSelf, PyObject * poArgs)
{
	...
	return Py_BuildValue("s", str_line.c_str());
}
...
void initgrpText()
{
	static PyMethodDef s_methods[] = {{"Update", grpTextUpdate, METH_VARARGS},
