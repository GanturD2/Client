...
void CGrannyModelInstance::SetLinkedModelPointer(CGrannyModel * pkModel, CGraphicVertexBuffer * pkSharedDeformableVertexBuffer,
...
uint32_t CGrannyModelInstance::GetVertexCount() const
{
	if (!m_pModel)
		return 0;
