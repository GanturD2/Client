...
void CGrannyModel::DeformPNTVertices(void * dstBaseVertices, D3DXMATRIX * boneMatrices,
...
granny_model * CGrannyModel::GetGrannyModelPointer() const
{
	return m_pgrnModel;
}
...
int CGrannyModel::GetIdxCount() const
{
	return m_idxCount;
}
