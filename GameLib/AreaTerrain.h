...
public:
	...
	// Shadow Texture
	void LoadShadowTexture(const char * ShadowFileName);

	// Shadow Map
	bool LoadShadowMap(const char * c_pszFileName);

	// MiniMap
	void LoadMiniMapTexture(const char * c_pchMiniMapFileName);
...
protected:
	...
	void PutImage32(const uint8_t * src, uint8_t * dst, long src_pitch, long dst_pitch, long texturewidth, long textureheight,
					bool bResize = false);
	void PutImage16(const uint8_t * src, uint8_t * dst, long src_pitch, long dst_pitch, long texturewidth, long textureheight,
					bool bResize = false);
