...
public:
	...
	void SoftwareTransformPatch_UpdateTerrainLighting(uint32_t dwVersion, const D3DLIGHT9 & c_rkLight, const D3DMATERIAL9 & c_rkMtrl);
...
public:
	SoftwareTransformPatch_SSourceVertex * SoftwareTransformPatch_GetTerrainVertexDataPtr() { return m_kST.m_akTerrainVertex; }
