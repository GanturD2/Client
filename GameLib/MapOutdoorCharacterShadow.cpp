...
void CMapOutdoor::CreateCharacterShadowTexture()
{
	...
	if (FAILED(ms_lpd3dDevice->CreateTexture(m_wShadowMapSize, m_wShadowMapSize, 1, D3DUSAGE_RENDERTARGET, D3DFMT_R5G6B5, D3DPOOL_DEFAULT,
...
bool CMapOutdoor::BeginRenderCharacterShadowToTexture()
{
	...
	D3DXVECTOR3 v3Eye(v3Target.x - 1.732f * 1250.0f, v3Target.y - 1250.0f, v3Target.z + 2.0f * 1.732f * 1250.0f);
	...
	D3DXMatrixOrthoRH(&matLightProj, m_fShadowSizeX, m_fShadowSizeY, 1.0f, 15000.0f);
#else
