...
public:
	...
	void CreateTarget(uint32_t dwPID, uint32_t dwQuestIndex, const char* c_pszTargetName, int iType, int iArg1, int iArg2, int iMapIndex, const char* c_pszTargetDesc = nullptr, int iSendFlag = 1);
