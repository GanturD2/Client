...
namespace building
{
	...
	public:
		...
		bool RequestCreateObject(uint32_t dwVnum, long lMapIndex, long x, long y, float xRot, float yRot, float zRot, bool checkAnother);
		...
		bool RequestCreateWallBlocks(uint32_t dwVnum, long nMapIndex, char wallSize, bool doorEast, bool doorWest, bool doorSouth, bool doorNorth);
	...
	protected:
		...
		// BUILD_WALL
	private:
		void DrawWall(uint32_t dwVnum, long nMapIndex, long& centerX, long& centerY, char length, float zRot);
		// END_BUILD_WALL
	};
