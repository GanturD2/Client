...
public:
	...
	void Destroy();
	bool Create(const char * c_szName, int brush = BLACK_BRUSH, uint32_t cs = 0, uint32_t ws = WS_OVERLAPPEDWINDOW, HICON hIcon = nullptr,
...
protected:
	const char * RegisterWindowClass(uint32_t style, int brush, WNDPROC pfnWndProc, HICON hIcon = nullptr, int iCursorResource = 32512);
