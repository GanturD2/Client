...
bool CVertexShader::CreateFromDiskFile(const char * c_szFileName, const unsigned long * c_pdwVertexDecl)
{
	Destroy();
	...
	if (FAILED(D3DXAssembleShaderFromFile(c_szFileName, 0, nullptr, 0, &lpd3dxShaderBuffer, &lpd3dxErrorBuffer)))
		return false;
