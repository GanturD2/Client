...
// FVF
void CStateManager::SaveFVF(uint32_t dwFVF)
{
...
void CStateManager::SetFVF(uint32_t dwFVF)
{
...
void CStateManager::GetFVF(uint32_t* dwFVF)
{
...
void CStateManager::SaveIndices(LPDIRECT3DINDEXBUFFER9 pIndexData, uint32_t BaseVertexIndex)
{
...
void CStateManager::SetIndices(LPDIRECT3DINDEXBUFFER9 pIndexData, uint32_t BaseVertexIndex)
{
...
HRESULT CStateManager::DrawPrimitiveUP(D3DPRIMITIVETYPE PrimitiveType, uint32_t PrimitiveCount, const void * pVertexStreamZeroData,
...
HRESULT CStateManager::DrawIndexedPrimitive(D3DPRIMITIVETYPE PrimitiveType, uint32_t minIndex, uint32_t NumVertices, uint32_t startIndex,
											uint32_t primCount, INT baseVertexIndex)
{
	return (m_lpD3DDev->DrawIndexedPrimitive(PrimitiveType, baseVertexIndex, minIndex, NumVertices, startIndex, primCount));
}

HRESULT CStateManager::DrawIndexedPrimitiveUP(D3DPRIMITIVETYPE PrimitiveType, uint32_t MinVertexIndex, uint32_t NumVertexIndices,
											  ...
											  CONST void * pVertexStreamZeroData, uint32_t VertexStreamZeroStride)
{
	...
	m_CurrentState.m_StreamData[0] = nullptr;
	return (m_lpD3DDev->DrawIndexedPrimitiveUP(PrimitiveType, MinVertexIndex, NumVertexIndices, PrimitiveCount, pIndexData, IndexDataFormat,
