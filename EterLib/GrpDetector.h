...
public:
	...
	~D3D_CAdapterDisplayModeList() {}
	VOID Build(IDirect3D9 & rkD3D, D3DFORMAT eD3DFmtDefault, uint32_t iD3DAdapterInfo);
...
public:
	D3D_CDeviceInfo() {}
	~D3D_CDeviceInfo() {}
	BOOL Build(IDirect3D9 & rkD3D, uint32_t iD3DAdapterInfo, uint32_t iDevType, D3D_CAdapterDisplayModeList & rkD3DADMList,
			   PFNCONFIRMDEVICE pfnConfirmDevice);
	...
	BOOL FindDepthStencilFormat(IDirect3D9 & rkD3D, uint32_t iD3DAdapterInfo, D3DDEVTYPE DeviceType, D3DFORMAT TargetFormat,
								D3DFORMAT * pDepthStencilFormat);

	D3D_SModeInfo & GetD3DModeInfor(uint32_t iD3DModeInfo);
	D3D_SModeInfo * GetD3DModeInfop(uint32_t iD3D_SModeInfo);
...
public:
	...
	BOOL Build(IDirect3D9 & rkD3D, uint32_t iD3DAdapterInfo, PFNCONFIRMDEVICE pfnConfirmDevice);
	VOID GetString(std::string * pstEnumList);

	D3DADAPTER_IDENTIFIER9 & GetIdentifier() { return m_kD3DAdapterIdentifier; }
	...
	D3D_SModeInfo * GetD3DModeInfop(uint32_t iD3DDevInfo, uint32_t iD3D_SModeInfo);
...
public:
	...
	BOOL Find(uint32_t uScrWidth, uint32_t uScrHeight, uint32_t uScrDepthBits, BOOL isWindowed, uint32_t * piD3DModeInfo,
			  uint32_t * piD3DDevInfo, uint32_t * piD3DAdapterInfo);
	...
	D3D_SModeInfo * GetD3DModeInfop(uint32_t iD3DAdapterInfo, uint32_t iD3DDevInfo, uint32_t iD3D_SModeInfo);
