...
public:
	...
	void RegisterResourceNewFunctionPointer(const char * c_szFileExt, CResource * (*pNewFunc)(const char * c_szFileName));
...
protected:
	...
	uint32_t __GetFileCRC(const char * c_szFileName, const char ** c_ppszLowerFileName = nullptr);
