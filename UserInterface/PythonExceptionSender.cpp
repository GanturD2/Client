...
{
	//uint32_t dwCRC32 = GetCaseCRC32(m_strExceptionString.c_str(), m_strExceptionString.length());
	...
	//m_kSet_dwSendedExceptionCRC.emplace(dwCRC32);
}

CPythonExceptionSender::CPythonExceptionSender() = default;
