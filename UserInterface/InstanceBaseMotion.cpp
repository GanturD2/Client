...
BOOL CInstanceBase::GetFishingRot(int * pirot)
{
	...
	for (float fRot = 0.0f; fRot <= 180.0f; fRot += 10.0f)
	{
		...
		ELPlainCoord_GetRotatedPixelPosition(c_rkPPosCur.x, c_rkPPosCur.y, c_fFishingDistance, fCharacterRot + fRot, &kPPosFishingRight.x,
											 &kPPosFishingRight.y);
		...
		ELPlainCoord_GetRotatedPixelPosition(c_rkPPosCur.x, c_rkPPosCur.y, c_fFishingDistance, fCharacterRot - fRot, &kPPosFishingLeft.x,
											 &kPPosFishingLeft.y);
