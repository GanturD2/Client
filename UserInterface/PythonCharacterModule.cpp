...
PyObject* chrRenderCollisionNew(PyObject* poSelf, PyObject* poArgs)
{
	CPythonCharacterManager::Instance().RenderCollisionNew();
	return Py_BuildNone();
}
...
PyObject * chrCreateInstance(PyObject * poSelf, PyObject * poArgs)
{
	...
	if (PyTuple_Size(poArgs) == 2)
	{
		...
		kCreateData.m_dwPendant = 0;
#endif
#ifdef ENABLE_ACHIEVEMENT_SYSTEM
		kCreateData.m_dwTitle = 0;
#endif
...
PyObject * chrCreateEffect(PyObject* poSelf, PyObject* poArgs)
{
	char * c_szEffName;
	if (!PyTuple_GetString(poArgs, 1, &c_szEffName))
	{
		return Py_BuildException();
	}
	...
	TPixelPosition pPos;
	pkInst->NEW_GetPixelPosition(&pPos);
	CEffectManager::Instance().RegisterEffect(c_szEffName);
	CEffectManager& rkEffMgr = CEffectManager::Instance();
	uint32_t dwEffectID = rkEffMgr.CreateEffect(c_szEffName,
		pPos,
		D3DXVECTOR3(0.0f, 0.0f, 0.0f));
	return Py_BuildValue("i", dwEffectID);
}

PyObject * chrDestroyEffect(PyObject* poSelf, PyObject* poArgs)
{
	int iEffectID;
...
PyObject* chrIsOfflineShop(PyObject* poSelf, PyObject* poArgs)
{
	...
	return Py_BuildValue("i", pInstance->IsShop());
}
#endif
...
PyObject* chrIsShowPrivateShowBoard(PyObject* poSelf, PyObject* poArgs)
{
	int iVirtualID;
	if (!PyTuple_GetInteger(poArgs, 0, &iVirtualID))
		return Py_BuildException();
	...
	CInstanceBase* pDestInstance = CPythonCharacterManager::Instance().GetInstancePtr(iVirtualID);
	if (!pMainInstance || !pDestInstance)
		return Py_BuildValue("b", FALSE);

	return Py_BuildValue("b", CPythonGraphicOnOff::Instance().IsPrivateShopOnOffLevel(pDestInstance->NEW_GetDistanceFromMainInstance()));
}
#endif
...
PyObject* chrIsShop(PyObject* poSelf, PyObject* poArgs)
{
	int iVirtualID;
	if (!PyTuple_GetInteger(poArgs, 0, &iVirtualID))
		return Py_BuildException();
...
void initchr()
{
	static PyMethodDef s_methods[] = {{"DismountHorse", chrDismountHorse, METH_VARARGS},
									  ...
									  {"RenderCollisionNew", chrRenderCollisionNew, METH_VARARGS},
		...
		{ "CreateEffect",				chrCreateEffect,					METH_VARARGS },
		{ "DestroyEffect",				chrDestroyEffect,					METH_VARARGS },
		...
		{ "SetAcce",					chrSetAcce,							METH_VARARGS },	//ENABLE_ACCE_COSTUME_SYSTEM
...
#ifdef ENABLE_GRAPHIC_ON_OFF
		{ "IsShowPrivateShowBoard",		chrIsShowPrivateShowBoard,			METH_VARARGS },
#endif
...
#endif
#ifdef ENABLE_PENDANT
	PyModule_AddIntConstant(poModule, "PART_PENDANT",						CRaceData::PART_PENDANT);
#endif
#ifdef ENABLE_AURA_SYSTEM
	...
	PyModule_AddIntConstant(poModule, "AFFECT_DASH",						CInstanceBase::AFFECT_DASH);
	...
	PyModule_AddIntConstant(poModule, "AFFECT_POLYMORPH",					CInstanceBase::AFFECT_POLYMORPH);
	...
	PyModule_AddIntConstant(poModule, "AFFECT_KING",						CInstanceBase::AFFECT_KING);
#endif
#ifdef ENABLE_GUILD_DRAGONLAIR_SYSTEM
	PyModule_AddIntConstant(poModule, "AFFECT_DRAGONLAIR_STONE_UNBEATABLE_1",CInstanceBase::AFFECT_DRAGONLAIR_STONE_UNBEATABLE_1);
	PyModule_AddIntConstant(poModule, "AFFECT_DRAGONLAIR_STONE_UNBEATABLE_2",CInstanceBase::AFFECT_DRAGONLAIR_STONE_UNBEATABLE_2);
	PyModule_AddIntConstant(poModule, "AFFECT_DRAGONLAIR_STONE_UNBEATABLE_3",CInstanceBase::AFFECT_DRAGONLAIR_STONE_UNBEATABLE_3);
#endif
#ifdef ENABLE_12ZI
	PyModule_AddIntConstant(poModule, "AFF_CZ_UNLIMIT_ENTER",				CInstanceBase::AFFECT_CZ_UNLIMIT_ENTER);
#endif
	...
	PyModule_AddIntConstant(poModule, "AFF_AFTERDEATH_SHIELD",				CInstanceBase::AFF_AFTERDEATH_SHIELD);
#endif
#ifdef ENABLE_BATTLE_FIELD
	PyModule_AddIntConstant(poModule, "AFFECT_TARGET_VICTIM",				CInstanceBase::AFFECT_TARGET_VICTIM);
#endif
	...
	PyModule_AddIntConstant(poModule, "EFFECT_SWORD_REFINED7TH",			CInstanceBase::EFFECT_SWORD_REFINED7TH);
#endif
...
#ifdef ENABLE_LVL96_WEAPON_EFFECT
	PyModule_AddIntConstant(poModule, "EFFECT_BOW_REFINED7TH",				CInstanceBase::EFFECT_BOW_REFINED7TH);
#endif
...
#ifdef ENABLE_LVL96_WEAPON_EFFECT
	PyModule_AddIntConstant(poModule, "EFFECT_FANBELL_REFINED7TH",			CInstanceBase::EFFECT_FANBELL_REFINED7TH);
#endif
...
#ifdef ENABLE_LVL96_WEAPON_EFFECT
	PyModule_AddIntConstant(poModule, "EFFECT_SMALLSWORD_REFINED7TH",		CInstanceBase::EFFECT_SMALLSWORD_REFINED7TH);
#endif
...
#ifdef ENABLE_LVL96_WEAPON_EFFECT
	PyModule_AddIntConstant(poModule, "EFFECT_SMALLSWORD_REFINED7TH_LEFT",	CInstanceBase::EFFECT_SMALLSWORD_REFINED7TH_LEFT);
#endif

#ifdef ENABLE_WOLFMAN_CHARACTER
	PyModule_AddIntConstant(poModule, "EFFECT_SWORD_REFINED7_W",			 CInstanceBase::EFFECT_SWORD_REFINED7_W);
	PyModule_AddIntConstant(poModule, "EFFECT_SWORD_REFINED8_W",			 CInstanceBase::EFFECT_SWORD_REFINED8_W);
	PyModule_AddIntConstant(poModule, "EFFECT_SWORD_REFINED9_W",			 CInstanceBase::EFFECT_SWORD_REFINED9_W);
#	ifdef ENABLE_LVL96_WEAPON_EFFECT
	PyModule_AddIntConstant(poModule, "EFFECT_SWORD_REFINED7TH_W",			CInstanceBase::EFFECT_SWORD_REFINED7TH_W);
#	endif

	PyModule_AddIntConstant(poModule, "EFFECT_SWORD_REFINED7_W_LEFT",		 CInstanceBase::EFFECT_SWORD_REFINED7_W_LEFT);
	PyModule_AddIntConstant(poModule, "EFFECT_SWORD_REFINED8_W_LEFT",		 CInstanceBase::EFFECT_SWORD_REFINED8_W_LEFT);
	PyModule_AddIntConstant(poModule, "EFFECT_SWORD_REFINED9_W_LEFT",		 CInstanceBase::EFFECT_SWORD_REFINED9_W_LEFT);
#	ifdef ENABLE_LVL96_WEAPON_EFFECT
	PyModule_AddIntConstant(poModule, "EFFECT_SWORD_REFINED7TH_W_LEFT",		CInstanceBase::EFFECT_SWORD_REFINED7TH_W_LEFT);
#	endif
#endif
	...
	PyModule_AddIntConstant(poModule, "EFFECT_BODYARMOR_SPECIAL_TH",		CInstanceBase::EFFECT_BODYARMOR_SPECIAL_TH);
#endif
	...
	PyModule_AddIntConstant(poModule, "EFFECT_COSTUMEBODY_YELLOW",			CInstanceBase::EFFECT_COSTUMEBODY_YELLOW);
	PyModule_AddIntConstant(poModule, "EFFECT_COSTUMEBODY_ORANGE",			CInstanceBase::EFFECT_COSTUMEBODY_ORANGE);
	PyModule_AddIntConstant(poModule, "EFFECT_COSTUMEBODY_BLUE",			CInstanceBase::EFFECT_COSTUMEBODY_BLUE);
	PyModule_AddIntConstant(poModule, "EFFECT_COSTUMEBODY_RED",				CInstanceBase::EFFECT_COSTUMEBODY_RED);
	PyModule_AddIntConstant(poModule, "EFFECT_COSTUMEBODY_GREEN",			CInstanceBase::EFFECT_COSTUMEBODY_GREEN);
	PyModule_AddIntConstant(poModule, "EFFECT_COSTUMEBODY_VIOLETT",			CInstanceBase::EFFECT_COSTUMEBODY_VIOLETT);
	PyModule_AddIntConstant(poModule, "EFFECT_COSTUMEBODY_WHITE",			CInstanceBase::EFFECT_COSTUMEBODY_WHITE);
#endif
#ifdef ENABLE_GROUP_DAMAGE_WEAPON_EFFECT
	PyModule_AddIntConstant(poModule, "EFFECT_SWORD_RARITY0",				CInstanceBase::EFFECT_SWORD_RARITY0);
	PyModule_AddIntConstant(poModule, "EFFECT_SWORD_RARITY1",				CInstanceBase::EFFECT_SWORD_RARITY1);
	PyModule_AddIntConstant(poModule, "EFFECT_SWORD_RARITY2",				CInstanceBase::EFFECT_SWORD_RARITY2);
	PyModule_AddIntConstant(poModule, "EFFECT_SWORD_RARITY3",				CInstanceBase::EFFECT_SWORD_RARITY3);
	PyModule_AddIntConstant(poModule, "EFFECT_SWORD_RARITY4",				CInstanceBase::EFFECT_SWORD_RARITY4);
	PyModule_AddIntConstant(poModule, "EFFECT_SWORD_RARITY5",				CInstanceBase::EFFECT_SWORD_RARITY5);
	PyModule_AddIntConstant(poModule, "EFFECT_SWORD_RARITY6",				CInstanceBase::EFFECT_SWORD_RARITY6);

	PyModule_AddIntConstant(poModule, "EFFECT_BOW_RARITY0",					CInstanceBase::EFFECT_BOW_RARITY0);
	PyModule_AddIntConstant(poModule, "EFFECT_BOW_RARITY1",					CInstanceBase::EFFECT_BOW_RARITY1);
	PyModule_AddIntConstant(poModule, "EFFECT_BOW_RARITY2",					CInstanceBase::EFFECT_BOW_RARITY2);
	PyModule_AddIntConstant(poModule, "EFFECT_BOW_RARITY3",					CInstanceBase::EFFECT_BOW_RARITY3);
	PyModule_AddIntConstant(poModule, "EFFECT_BOW_RARITY4",					CInstanceBase::EFFECT_BOW_RARITY4);
	PyModule_AddIntConstant(poModule, "EFFECT_BOW_RARITY5",					CInstanceBase::EFFECT_BOW_RARITY5);
	PyModule_AddIntConstant(poModule, "EFFECT_BOW_RARITY6",					CInstanceBase::EFFECT_BOW_RARITY6);

	PyModule_AddIntConstant(poModule, "EFFECT_FANBELL_RARITY0",				CInstanceBase::EFFECT_FANBELL_RARITY0);
	PyModule_AddIntConstant(poModule, "EFFECT_FANBELL_RARITY1",				CInstanceBase::EFFECT_FANBELL_RARITY1);
	PyModule_AddIntConstant(poModule, "EFFECT_FANBELL_RARITY2",				CInstanceBase::EFFECT_FANBELL_RARITY2);
	PyModule_AddIntConstant(poModule, "EFFECT_FANBELL_RARITY3",				CInstanceBase::EFFECT_FANBELL_RARITY3);
	PyModule_AddIntConstant(poModule, "EFFECT_FANBELL_RARITY4",				CInstanceBase::EFFECT_FANBELL_RARITY4);
	PyModule_AddIntConstant(poModule, "EFFECT_FANBELL_RARITY5",				CInstanceBase::EFFECT_FANBELL_RARITY5);
	PyModule_AddIntConstant(poModule, "EFFECT_FANBELL_RARITY6",				CInstanceBase::EFFECT_FANBELL_RARITY6);

	PyModule_AddIntConstant(poModule, "EFFECT_SMALLSWORD_RARITY0",			CInstanceBase::EFFECT_SMALLSWORD_RARITY0);
	PyModule_AddIntConstant(poModule, "EFFECT_SMALLSWORD_RARITY1",			CInstanceBase::EFFECT_SMALLSWORD_RARITY1);
	PyModule_AddIntConstant(poModule, "EFFECT_SMALLSWORD_RARITY2",			CInstanceBase::EFFECT_SMALLSWORD_RARITY2);
	PyModule_AddIntConstant(poModule, "EFFECT_SMALLSWORD_RARITY3",			CInstanceBase::EFFECT_SMALLSWORD_RARITY3);
	PyModule_AddIntConstant(poModule, "EFFECT_SMALLSWORD_RARITY4",			CInstanceBase::EFFECT_SMALLSWORD_RARITY4);
	PyModule_AddIntConstant(poModule, "EFFECT_SMALLSWORD_RARITY5",			CInstanceBase::EFFECT_SMALLSWORD_RARITY5);
	PyModule_AddIntConstant(poModule, "EFFECT_SMALLSWORD_RARITY6",			CInstanceBase::EFFECT_SMALLSWORD_RARITY6);

	PyModule_AddIntConstant(poModule, "EFFECT_SMALLSWORD_RARITY0_LEFT",		CInstanceBase::EFFECT_SMALLSWORD_RARITY0_LEFT);
	PyModule_AddIntConstant(poModule, "EFFECT_SMALLSWORD_RARITY1_LEFT",		CInstanceBase::EFFECT_SMALLSWORD_RARITY1_LEFT);
	PyModule_AddIntConstant(poModule, "EFFECT_SMALLSWORD_RARITY2_LEFT",		CInstanceBase::EFFECT_SMALLSWORD_RARITY2_LEFT);
	PyModule_AddIntConstant(poModule, "EFFECT_SMALLSWORD_RARITY3_LEFT",		CInstanceBase::EFFECT_SMALLSWORD_RARITY3_LEFT);
	PyModule_AddIntConstant(poModule, "EFFECT_SMALLSWORD_RARITY4_LEFT",		CInstanceBase::EFFECT_SMALLSWORD_RARITY4_LEFT);
	PyModule_AddIntConstant(poModule, "EFFECT_SMALLSWORD_RARITY5_LEFT",		CInstanceBase::EFFECT_SMALLSWORD_RARITY5_LEFT);
	PyModule_AddIntConstant(poModule, "EFFECT_SMALLSWORD_RARITY6_LEFT",		CInstanceBase::EFFECT_SMALLSWORD_RARITY6_LEFT);
#endif
	// END_EFFECT
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	// Custom
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_AUTO",					CInstanceBase::NEW_AFFECT_AUTO);
	PyModule_AddIntConstant(poModule, "AFFECT_AUTO_USE",					CInstanceBase::AFFECT_AUTO_USE);
#endif
//#ifdef ENABLE_YOHARA_SYSTEM
...
//#endif
	...
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_BATTLE_FIELD",						CInstanceBase::NEW_AFFECT_BATTLE_FIELD);
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_BATTLE_POTION",						CInstanceBase::NEW_AFFECT_BATTLE_POTION);
	...
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_PASSIVE_JOB_DECK",		CInstanceBase::NEW_AFFECT_PASSIVE_JOB_DECK);
#endif
...
#endif
#ifdef ENABLE_AFK_MODE_SYSTEM
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_AFK",						CInstanceBase::NEW_AFFECT_AFK);
#endif
#ifdef ENABLE_SOUL_SYSTEM
	PyModule_AddIntConstant(poModule, "AFFECT_SOUL_RED",					CInstanceBase::NEW_AFFECT_SOUL_RED);
	PyModule_AddIntConstant(poModule, "AFFECT_SOUL_BLUE",					CInstanceBase::NEW_AFFECT_SOUL_BLUE);
	PyModule_AddIntConstant(poModule, "AFFECT_SOUL_MIX",					CInstanceBase::NEW_AFFECT_SOUL_MIX);
#endif
	...
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_BATTLE_POTION",			CInstanceBase::NEW_AFFECT_BATTLE_POTION);
#endif
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_POTION_1",				CInstanceBase::AFFECT_POTION_1);
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_POTION_2",				CInstanceBase::AFFECT_POTION_2);
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_POTION_3",				CInstanceBase::AFFECT_POTION_3);
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_POTION_4",				CInstanceBase::AFFECT_POTION_4);
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_POTION_5",				CInstanceBase::AFFECT_POTION_5);
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_POTION_6",				CInstanceBase::AFFECT_POTION_6);
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_POLYMORPH",				CInstanceBase::NEW_AFFECT_POLYMORPH);
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_EXPRING",					CInstanceBase::AFFECT_EXPRING);

#ifdef ENABLE_YOHARA_SYSTEM
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_SUNGMA_MAP_INFO",			CInstanceBase::NEW_AFFECT_SUNGMA_MAP_INFO);
	...
	PyModule_AddIntConstant(poModule, "AFFECT_FLOWER_EVENT",				CInstanceBase::AFFECT_FLOWER_EVENT);
#endif
