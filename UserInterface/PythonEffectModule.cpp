...
void initeffect()
{
	static PyMethodDef s_methods[] = {{"RegisterEffect", effectRegisterEffect, METH_VARARGS},
...
#endif
#ifdef ENABLE_PROTO_RENEWAL
	PyModule_AddIntConstant(poModule, "FLY_ILGWANGPYO_NORMAL",		FLY_ILGWANGPYO_NORMAL);
	PyModule_AddIntConstant(poModule, "FLY_ILGWANGPYO_MASTER",		FLY_ILGWANGPYO_MASTER);
	PyModule_AddIntConstant(poModule, "FLY_ILGWANGPYO_GRAND_MASTER", FLY_ILGWANGPYO_GRAND_MASTER);
	PyModule_AddIntConstant(poModule, "FLY_ILGWANGPYO_PERFECT_MASTER", FLY_ILGWANGPYO_PERFECT_MASTER);
#	ifdef ENABLE_YOHARA_SYSTEM
