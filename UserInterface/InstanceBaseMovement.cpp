...
void CInstanceBase::NEW_SyncPixelPosition(const long & nPPosX, const long & nPPosY)
{
...
float CInstanceBase::NEW_GetAdvancingRotationFromDirPixelPosition(const TPixelPosition & c_rkPPosDir) const
{
...
float CInstanceBase::NEW_GetAdvancingRotationFromPixelPosition(const TPixelPosition & c_rkPPosSrc, const TPixelPosition & c_rkPPosDst) const
{
	TPixelPosition kPPosDelta = c_rkPPosDst - c_rkPPosSrc;
...
BOOL CInstanceBase::IsGoing() const
{
	return m_isGoing;
}
