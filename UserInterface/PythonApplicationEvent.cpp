...
void CPythonApplication::OnUIUpdate() const
{
	UI::CWindowManager & rkUIMgr = UI::CWindowManager::Instance();
	rkUIMgr.Update();
}

void CPythonApplication::OnUIRender() const
{
	UI::CWindowManager & rkUIMgr = UI::CWindowManager::Instance();
	rkUIMgr.Render();
}

void CPythonApplication::OnSizeChange(int width, int height) const {}
...
void CPythonApplication::OnMouseWheel(int nLen) const
{
...
void CPythonApplication::OnMouseLeftButtonDown(int x, int y) const
{
	UI::CWindowManager & rkWndMgr = UI::CWindowManager::Instance();
	rkWndMgr.RunMouseLeftButtonDown(x, y);
}

void CPythonApplication::OnMouseLeftButtonUp(int x, int y) const
{
	UI::CWindowManager & rkWndMgr = UI::CWindowManager::Instance();
	rkWndMgr.RunMouseLeftButtonUp(x, y);
}

void CPythonApplication::OnMouseLeftButtonDoubleClick(int x, int y) const
{
	UI::CWindowManager & rkWndMgr = UI::CWindowManager::Instance();
	rkWndMgr.RunMouseLeftButtonDown(x, y);
...
void CPythonApplication::OnMouseRightButtonDown(int x, int y) const
{
	UI::CWindowManager & rkWndMgr = UI::CWindowManager::Instance();
	rkWndMgr.RunMouseRightButtonDown(x, y);
}

void CPythonApplication::OnMouseRightButtonUp(int x, int y) const
{
	UI::CWindowManager & rkWndMgr = UI::CWindowManager::Instance();
...
void CPythonApplication::OnIMEKeyDown(int iIndex) const
{
	UI::CWindowManager & rkWndMgr = UI::CWindowManager::Instance();
...
/////////////////////////////
void CPythonApplication::RunPressExitKey() const
{
	UI::CWindowManager & rkWndMgr = UI::CWindowManager::Instance();
...
///////////////////////////////////////////////////////////////////////////////////////////////////
void CPythonApplication::OnMouseUpdate() const
{
#ifdef _DEBUG
	if (!m_poMouseHandler)
	{
...
void CPythonApplication::OnMouseRender() const
{
#ifdef _DEBUG
	if (!m_poMouseHandler)
	{
