...
PyObject * miniMapGetInfo(PyObject * poSelf, PyObject * poArgs)
{
	...
	iPosX /= 100;
	iPosY /= 100;
	return Py_BuildValue("isiil", static_cast<int>(bFind), aString.c_str(), iPosX, iPosY, static_cast<signed>(dwTextColor));
}
...
PyObject * miniMapGetAtlasInfo(PyObject * poSelf, PyObject * poArgs)
{
	...
	iPosX /= 100;
	iPosY /= 100;
	return Py_BuildValue("isiili", static_cast<int>(bFind), aString.c_str(), iPosX, iPosY, static_cast<signed>(dwTextColor), dwGuildID);
}
...
PyObject * miniMapGetAtlasSize(PyObject * poSelf, PyObject * poArgs)
{
	...
	*/
	...
	return Py_BuildValue("bii", static_cast<int>(bGet), iSizeX, iSizeY);
}
...
void initMiniMap()
{
	static PyMethodDef s_methods[] = {{"SetScale", miniMapSetScale, METH_VARARGS},
