...
void CSoundInstance3D::Play(int iLoopCount, uint32_t dwPlayCycleTimeLimit) const
{
	if (!m_pSoundData)
		return;
...
void CSoundInstance3D::SetOrientation(float x_face, float y_face, float z_face, float x_normal, float y_normal, float z_normal) const
{
