...
{
	const auto byByte = static_cast<const unsigned char>(chByte);
...
{
	const auto * uszString1 = reinterpret_cast<const unsigned char *>(szStringLeft);
	const auto * uszString2 = reinterpret_cast<const unsigned char *>(szStringRight);
	uint16_t c2;
